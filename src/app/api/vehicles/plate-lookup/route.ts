...
function normalizeVehiclePayload(raw: unknown): VehicleLookupResponse {
  ...
  return {
    brand: findString(source, ["brand", "make", "marca"]) || "",
    model: findString(source, ["model", "modello"]) || "",
    version: findString(source, ["version", "trim", "allestimento"]) || "",
    year: findString(source, ["year", "modelYear", "anno"]) || "",
    fuel: findString(source, ["fuel", "fuelType", "alimentazione"]) || "",
    transmission: findString(source, ["transmission", "gearbox", "cambio"]) || "",
    engineSize: findString(source, ["engineSize", "engineDisplacement", "cilindrata"]) || "",
    powerKw: findString(source, ["powerKw", "kw", "power", "potenzaKw"]) || "",
    powerHp: findString(source, ["powerHp", "hp", "cv", "potenzaCv"]) || "",
    doors: findString(source, ["doors", "doorCount", "porte"]) || "",
