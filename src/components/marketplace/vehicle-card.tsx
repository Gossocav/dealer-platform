      ...
      <div className="space-y-4 p-5">
        ...
        <div className="flex items-center justify-between gap-2 border-t border-white/10 pt-4">
          ...
          <div className="flex flex-none gap-2">
            {/* Sta sopra il collegamento che copre tutta la scheda: senza z-10
                il tocco aprirebbe l'auto e il venditore non si raggiungerebbe.
                Un collegamento dentro un altro non e' valido e vince l'esterno. */}
            <Link
