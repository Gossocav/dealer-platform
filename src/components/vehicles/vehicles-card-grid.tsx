...
export function VehiclesCardGrid({ items }: VehiclesCardGridProps) {
  return (
        ...
        >
          ...
          <div className="space-y-4 p-5">
            ...
            <p className="inline-flex items-center gap-1 text-xs uppercase tracking-[0.14em] text-slate-400">
              <CalendarDays className="h-3.5 w-3.5" /> Inserito il {new Date(vehicle.insertedAt).toLocaleDateString("it-IT")}
            </p>
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1 rounded-xl border border-slate-200 bg-white px-3 py-2 font-medium text-slate-700 transition hover:bg-slate-50"
              >
                <Rocket className="h-4 w-4" /> Pubblica
              </button>
              <button
                type="button"
                className="col-span-2 inline-flex items-center justify-center gap-1 rounded-xl border border-red-200 bg-red-50 px-3 py-2 font-medium text-red-700 transition hover:bg-red-100"
              >
