...
describe("fraseConteggioVeicoli", () => {
  /**
   * **La firma e' cambiata il 20/09/2026, e non e' un aggiustamento.**
   *
   * Prima prendeva "quanti ne mostra, quanti ne ha caricati, quanti ce ne
   * sono": aveva senso finche' la pagina caricava tutto e filtrava nel
   * browser. Adesso filtra il database, quindi "caricati" non vuol piu' dire
   * niente -- cio' che conta e' **se un filtro e' attivo**, perche' e'
   * quello a decidere se il numero mostrato e' la vetrina o una parte.
   */
  ...
  it("con un filtro attivo non dice piu' 'in vetrina'", () => {
    // Le 12 mostrate sono un sottoinsieme: dirle "in vetrina" su una
    // concessionaria che ne ha 133 sarebbe falso.
  ...
  it("se l'elenco e' stato tagliato dal tetto lo dice", () => {
    // Il caso che rompeva tutto: 420 in vetrina, la richiesta ne prende 300.
    // Prima si leggeva "300 auto" -- preciso, credibile, sbagliato di 120.
